...
| ~~DPIDR = `0x6BA0009D` 는 깨진 값~~ | **이 폐기가 틀렸다.** `0x6BA0009D` 는 **JTAG TAP 의 IDCODE**(part `0xBA00` = ARM CoreSight DAP 계열)이고 `0x11013913` 은 **DPIDR 레지스터**다 — 서로 다른 것이고 **둘 다 참**이다 |
...
|---|---|---|---|
| `0x11013913` | **3** (DPv3) | `0x489` SiFive | ✅ 유효 |
