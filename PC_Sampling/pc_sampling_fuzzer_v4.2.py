...
class JLinkPCSampler:
    """J-Link Halt-Sample-Resume 기반 PC 수집기 (v4.2: 글로벌 포화 + idle PC 감지)"""
    ...
    def _sampling_worker(self):
        """v4.2: 글로벌 기준 포화 판정 + idle PC 기반 조기 중단"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='PC Sampling SSD Fuzzer v4.2')
