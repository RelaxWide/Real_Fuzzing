...
| 명령어 | 시드 수 | 예시 |
|---|---|---|
| **Read** | **10** | LBA 0/1/500/1000/5000/10000, NLB 1/8/32/128, FUA 플래그 |
| **Write** | **10** | LBA 0/500/1000/5000/10000, NLB 1/8, 패턴 0x00/0xAA/0xFF/순차, FUA 플래그 |
...
Read/Write를 각 10개로 늘린 이유: 초기 corpus에서 비중이 높아지면 AFLfast 에너지 스케줄러가 자연스럽게 Read/Write를 더 자주 선택하게 된다 (새 시드는 모두 max_energy=16으로 시작). 에너지 공식에는 손대지 않아 AFLfast의 수학적 특성을 유지한다.
