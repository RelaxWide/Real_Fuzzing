...
```bash
python3 pc_sampling_fuzzer_v4.4.py \
...
# v4.4: NVMe 스펙 매핑 우선, 없으면 unknown
...
| 원래 명령어 | opcode_override | force_admin | v4.3 결과 | v4.4 결과 |
|---|---|---|---|---|
...
2. dmesg 마지막 80줄 캡처                  ← v4.4 NEW
3. dmesg에서 NVMe 관련 라인 요약 출력      ← v4.4 NEW
4. crash 저장 (stuck PC + dmesg 포함)      ← v4.4 확장
...
| `--output` | ./output/pc_sampling_v4.4/ | 출력 디렉토리 |
...
│   ├── crash_Identify_0x6_....dmesg.txt  # v4.4: 커널 로그 스냅샷
│   └── ...
└── graphs/                        # 시각화 출력
