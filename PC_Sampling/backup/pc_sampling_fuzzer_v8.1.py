#!/usr/bin/env python3
"""
PC Sampling 기반 SSD 펌웨어 Coverage-Guided Fuzzer v8.1
...
PRODUCT_PROFILES = {
    ...
    'P9': {
        ...
        'sampler_type':       'jlink_halt',  # v8.1: P9 는 pylink 직접 halt (OpenOCD telnet desync 회피)
...
PRODUCT_CONFIGS = {
    _name: {'interface': _p['interface'], 'openocd_config': _p['openocd_config']}
...
if __name__ == "__main__":
    ...
    if args.product is not None:
        ...
        resolved_cfg = _profile['openocd_config']
    ...
    config = FuzzConfig(
        ...
        # v8.0: target profile 주입
        jlink_device=_profile['jlink_device'],
        tcl_prefix=_profile['tcl_prefix'],
        pcsr_addrs=_profile['pcsr_addrs'],
        power_addr=_profile['power_addr'],
        power_mask=_profile['power_mask'],
        invalid_pc_vals=tuple(_profile['invalid_pc_vals']) if _profile['invalid_pc_vals'] else (),
